...
| `ladder.py` | Runs the published tier ladder over every measured school and prints only the disagreements with the hand tiers, for a human to decide. Five today. |
